    ...
    <main>
      <header className="site-header">
        ...
        <nav aria-label="ページ内ナビゲーション">
          ...
          <a href="#setup">導入方法</a>
          <span className="status-pill"><i /> v0.26.35 live</span>
        </nav>
      </header>
      ...
      <footer>
        ...
        <div><a href="#convert">変換する</a><a href="#setup">導入方法</a><a href="/privacy">プライバシー</a><a href="/security">セキュリティ</a><span>v0.26.35</span></div>
      </footer>
    </main>
  );
}
