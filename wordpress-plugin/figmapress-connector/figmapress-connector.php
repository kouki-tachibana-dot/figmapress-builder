...
define( 'FIGMAPRESS_CONNECTOR_VERSION', '0.19.11' );

require_once FIGMAPRESS_CONNECTOR_DIR . 'includes/pairing.php';
require_once FIGMAPRESS_CONNECTOR_DIR . 'includes/responsive.php';
require_once FIGMAPRESS_CONNECTOR_DIR . 'includes/rest-api.php';
require_once FIGMAPRESS_CONNECTOR_DIR . 'includes/site-map.php';
require_once FIGMAPRESS_CONNECTOR_DIR . 'includes/review-site.php';
...
function figmapress_connector_register_elementor_assets() {
    ...
    wp_register_style(
        'figmapress-elementor-accessibility-0195',
        FIGMAPRESS_CONNECTOR_URL . 'assets/elementor-accessibility-0195.css',
        array( 'figmapress-elementor-accessibility-0194' ),
        null
    );
    wp_register_script(
        'figmapress-elementor-accessibility-0195',
        FIGMAPRESS_CONNECTOR_URL . 'assets/elementor-accessibility-0195.js',
        array( 'figmapress-elementor-accessibility-0194' ),
        null,
        true
    );
    wp_register_script(
        'figmapress-elementor-accessibility-0196',
        FIGMAPRESS_CONNECTOR_URL . 'assets/elementor-accessibility-0196.js',
        array( 'figmapress-elementor-accessibility-0195' ),
        null,
        true
    );
    if ( ! wp_style_is( 'figmapress-elementor-responsive-0198', 'registered' ) ) {
        wp_register_style(
            'figmapress-elementor-responsive-0198',
            false,
            array( 'figmapress-elementor-accessibility-0195' ),
            null
        );
        wp_add_inline_style( 'figmapress-elementor-responsive-0198', figmapress_connector_responsive_css() );
    }
}
...
function figmapress_connector_enqueue_owned_elementor_assets() {
    ...
    wp_enqueue_style( 'figmapress-elementor-responsive-0198' );
}
